...
<html lang="en">
  ...
  <body>
    <table class="confirmation" border="0" cellpadding="0" cellspacing="0" align="center" style="width: 95%; max-width: 600px; background: #f8fcfe" >
      <thead style="background-image: url('{{ asset('adminlte/images/boxed-bg.jpg') }}'); background-repeat: no-repeat; background-size: 100%; text-align: center; background-position: top;">
        <tr rowspan="12">
          <td colspan="12" class="logo-td" style="text-align: center; padding-top: 20px; padding-bottom: 0px" >
            <img src="{{ asset('adminlte/images/llcf-white-header.png') }}" class="logo" style="width: 205px; height: 205px; object-fit: contain" />
          </td>
        </tr>
      </thead>
      <tbody align="center">
        ...
        <tr rowspan="12">
          <td colspan="12" style="padding-top: 34px; padding-bottom: 40px">
            <a href="javascript:void(0);" style="text-decoration: none;">
                <img style="margin-right: 20px" src="{{ asset('adminlte/images/facebook.svg') }}" alt="Facebook" />
            </a>
            <a href="javascript:void(0);" style="text-decoration: none;">
                <img style="margin-right: 20px" src="{{ asset('adminlte/images/instagram.svg') }}" alt="Instagram" />
            </a>
            <a href="javascript:void(0);" style="text-decoration: none;">
                <img style="margin-right: 20px" src="{{ asset('adminlte/images/linkedin.svg') }}" alt="LinkedIn" />
            </a>
            <a href="javascript:void(0);" style="text-decoration: none;">
              <img src="{{ asset('adminlte/images/twitter.svg') }}" alt="Twitter" />
            </a>
          </td>
        </tr>
      </tfoot>
