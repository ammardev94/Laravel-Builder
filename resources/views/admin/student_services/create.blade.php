    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Add Student Service</h3>
            </div>

            <form action="{{ route('admin.student_services.store') }}" method="POST" id="addStudentServiceForm">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <!-- Student -->
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="service" id="service" class="form-control" placeholder="Enter service" value="{{ old('service') }}" required>
...
<script>
    $(document).ready(function () {
        ...
        $('#addStudentServiceForm').validate({
            rules: {
