...
<div class="content">
  <div class="container-fluid">
    ...
    <div class="card card-primary">
      ...
      <form action="{{ route('admin.vtc_student_academic_records.store') }}" method="POST" id="addAcademicRecordForm">
        @csrf
        <div class="card-body">
          <div class="row">
...
<script>
    $(document).ready(function () {
        ...
        $('#addAcademicRecordForm').validate({
            rules: {
