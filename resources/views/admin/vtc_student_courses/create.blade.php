    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title mb-0">Assign Course to Student</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.vtc_student_courses.store') }}" method="POST" id="assignCourseForm">
                    @csrf
