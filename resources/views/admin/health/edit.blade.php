...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Edit Health Record</h1>
      </div>
      <div class="col-sm-6">
...
<div class="content">
  <div class="container-fluid">
    ...
    <div class="card card-primary">
        ...
        <form action="{{ route('admin.health.update', $healthRecord->id) }}" method="POST" id="editHealthForm">
            @csrf
            @method('PUT')
                ...
                <div class="row">
                        ...
                        <select name="family_id" class="form-control" required>
                            ...
                            @foreach($families as $family)
                                <option value="{{ $family->id }}"
                                    {{ old('family_id', $healthRecord->family_id) == $family->id ? 'selected' : '' }}>
                                    {{ $family->father_name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    @php
                        $fields = [
                            ...
                            ['bmi_percentile', 'text', 'Enter BMI percentile'],
                    ...
                    @foreach ($fields as $field)
                        @php
                            ...
                            $value = old($name, $healthRecord->$name);
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="{{ $type }}" name="{{ $name }}" class="form-control"
                                placeholder="{{ $placeholder }}" value="{{ $value }}" {{ $attr }} required>
                            @error($name)
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
