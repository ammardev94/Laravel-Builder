                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="stu_full_name" class="form-control" placeholder="Enter full name" value="{{ old('stu_full_name') }}" required minlength="3">
                            <div class="invalid-feedback">{{ $errors->first('stu_full_name') }}</div>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label for="stu_dob">DOB</label>
                            <input type="date" name="stu_dob" class="form-control" value="{{ old('stu_dob') }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="gr_num" class="form-control" placeholder="Enter GR number" value="{{ old('gr_num') }}" required>
                            <div class="invalid-feedback">{{ $errors->first('gr_num') }}</div>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label for="auto_gr_num">Auto GR Number</label>
                            <input type="text" name="auto_gr_num" class="form-control" placeholder="Enter GR number" value="{{ old('auto_gr_num') }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="donation_expiry" class="form-control" value="{{ old('donation_expiry') }}" required>
        ...
        $('#addStudentForm').validate({
            ...
            messages: {
                ...
                donation_date: {
                    ...
                    noFutureDate: "Donation date can't be in future"
                },
                donation_expiry: {
