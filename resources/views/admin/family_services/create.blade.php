...
<div class="content">
  <div class="container-fluid">
    ...
    <div class="card card-primary">
      ...
      <form action="{{ route('admin.family_services.store') }}" method="POST" id="addFamilyServiceForm">
        @csrf
        <div class="card-body">
          <div class="row">
              ...
              <div class="form-group">
                ...
                <select name="family_id" id="family_id" class="form-control" required>
                  ...
                  @foreach($families as $family)
                    <option value="{{ $family->id }}">{{ $family->father_name }} ({{ $family->father_cnic }})</option>
                  @endforeach
                </select>
            ...
            <div class="col-md-6 mb-3">
              <div class="form-group">
                ...
                <input type="text" name="service" class="form-control" placeholder="Enter service name" value="{{ old('service') }}" required>
        ...
        <div class="card-footer">
          ...
          <a href="{{ route('admin.family_services.index') }}" class="btn btn-default"><i class="fas fa-times-circle"></i>&nbsp;&nbsp;Cancel</a>
        </div>
      </form>
    </div>
  </div>
